...
from .modeling_llama_haha import LlamaModel, LlamaForCausalLM
    ...
    def forward(
        ...
        **kwargs
        ...
        if early_exit_layers is not None:
            # [DeCo 改进] 强制输出 hidden_states 以便获取中间层表示
        ...
        # [DeCo 改进] 解码器输出包含 (dec_features, layer_state, dec_hidden, dec_attn)
        outputs = self.model(
            input_ids=input_ids,
